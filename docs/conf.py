...
extensions = ['sphinx.ext.autodoc', 'sphinx_epytext', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.viewcode']
...
def pywikibot_script_docstring_fixups(
    ...
    result = ['This script supports use of :py:mod:`pywikibot.pagegenerators` arguments.' if l in ('&params;', '&pagegenerators_help;') else
