...
#
    ...
    def login(self, sysop=False):
        ...
        if login_result:
            # TODO: If should not be necessary to getuserinfo, as userinfo
            # will be loaded as part of the next request.  However we'll
            # maintain it for the successful login code path.
            self.getuserinfo()
