...
def request(site=None, uri=None, method='GET', body=None, headers=None,
    ...
    L{request_normal} should be used instead.
...
def _enqueue(uri, method="GET", body=None, headers=None, **kwargs):
    ...
    The kwargs may contain a 'callbacks' (plural), in which case the
    default error handler and 'callback' (singural) are executed first.
    ...
    @kwarg default_error_handling: Use default error handling before callback
