...
class WikimediaFamily(Family):
    ...
    def interwiki_removals(self):
        return tuple(self.removed_wikis + self.closed_wikis)

    @interwiki_removals.setter
    def interwiki_removals(self, value):
        raise TypeError('WikimediaFamily.interwiki_removals is read-only')
    ...
    @interwiki_replacements.setter
    def interwiki_replacements(self, value):
        raise TypeError(
            'WikimediaFamily.interwiki_replacements is read-only')
